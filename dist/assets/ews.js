...
define('ews/components/notification-hierarchy-item', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Component.extend({
    item: null,
...
define('ews/components/notification-hierarchy', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Component.extend({
    displaySubtitle: true
  });
});
...
define('ews/components/warning-info', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Component.extend({
    ...
    didReceiveAttrs: function didReceiveAttrs() {
      this.get('report.notifications').then(function (notifs) {
        notifs.forEach(function (notif) {
          notif.get('subject').then(function (subject) {
...
define("ews/mirage/fixtures/notifications", ["exports"], function (exports) {
  exports["default"] = [{
    id: 1,
    ownerId: 1,
    subjectId: 5
...
define('ews/mirage/models/notification', ['exports', 'ember-cli-mirage'], function (exports, _emberCliMirage) {
  exports['default'] = _emberCliMirage.Model.extend({
    owner: (0, _emberCliMirage.belongsTo)('user', { inverse: 'notifications' }),
    subject: (0, _emberCliMirage.belongsTo)('user', { inverse: 'topics' })
  });
});
define('ews/mirage/models/user', ['exports', 'ember-cli-mirage'], function (exports, _emberCliMirage) {
  exports['default'] = _emberCliMirage.Model.extend({
    ...
    notifications: (0, _emberCliMirage.hasMany)('notification', { inverse: 'owner' }),
    topics: (0, _emberCliMirage.hasMany)('notification', { inverse: 'subject' })
  });
});
...
define('ews/models/notification', ['exports', 'ember-data'], function (exports, _emberData) {
  exports['default'] = _emberData['default'].Model.extend({
    owner: _emberData['default'].belongsTo('user', { inverse: 'notifications' }),
    subject: _emberData['default'].belongsTo('user', { inverse: 'topics' })
  });
});
define('ews/models/user', ['exports', 'ember-data', 'ember'], function (exports, _emberData, _ember) {
  exports['default'] = _emberData['default'].Model.extend({
    ...
    notifications: _emberData['default'].hasMany('notification', { inverse: 'owner' }),
    topics: _emberData['default'].hasMany('notification', { inverse: 'subject' }),
...
define("ews/templates/components/notification-hierarchy-item", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "8n7zs/fg", "block": "{\"statements\":[[\"block\",[\"cp-panel\"],null,[[\"name\"],[[\"get\",[\"name\"]]]],7],[\"yield\",\"default\"],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[\"default\"],\"blocks\":[{\"statements\":[[\"text\",\"    \"],[\"append\",[\"helper\",[\"notification-hierarchy-item\"],null,[[\"item\"],[[\"get\",[\"sub\"]]]]],false],[\"text\",\"\\n\"]],\"locals\":[\"sub\"]},{\"statements\":[[\"block\",[\"each\"],[[\"get\",[\"item\",\"subordinates\"]]],null,0]],\"locals\":[]},{\"statements\":[[\"text\",\"        \"],[\"open-element\",\"span\",[]],[\"static-attr\",\"class\",\"glyphicon glyphicon-asterisk\"],[\"static-attr\",\"aria-hidden\",\"true\"],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[]},{\"statements\":[[\"text\",\"          \"],[\"open-element\",\"span\",[]],[\"static-attr\",\"class\",\"glyphicon glyphicon-plus\"],[\"static-attr\",\"aria-hidden\",\"true\"],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[]},{\"statements\":[[\"text\",\"          \"],[\"open-element\",\"span\",[]],[\"static-attr\",\"class\",\"glyphicon glyphicon-minus\"],[\"static-attr\",\"aria-hidden\",\"true\"],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[]},{\"statements\":[[\"block\",[\"if\"],[[\"get\",[\"p\",\"isOpen\"]]],null,4,3]],\"locals\":[]},{\"statements\":[[\"block\",[\"p\",\"toggle\"],null,null,5]],\"locals\":[]},{\"statements\":[[\"text\",\"  \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"row hierarchy-item\"],[\"flush-element\"],[\"text\",\"\\n    \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"row hierarchy-wrapper\"],[\"flush-element\"],[\"text\",\"\\n      \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-1\"],[\"flush-element\"],[\"text\",\"\\n\"],[\"block\",[\"if\"],[[\"get\",[\"item\",\"subordinates\"]]],null,6,2],[\"text\",\"        \"],[\"open-element\",\"img\",[]],[\"dynamic-attr\",\"src\",[\"unknown\",[\"item\",\"photo\"]],null],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n      \"],[\"close-element\"],[\"text\",\"\\n      \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-3\"],[\"flush-element\"],[\"open-element\",\"strong\",[]],[\"flush-element\"],[\"append\",[\"unknown\",[\"item\",\"fullName\"]],false],[\"close-element\"],[\"close-element\"],[\"text\",\"\\n      \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-3\"],[\"flush-element\"],[\"append\",[\"unknown\",[\"item\",\"employeeId\"]],false],[\"close-element\"],[\"text\",\"\\n      \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-3\"],[\"flush-element\"],[\"append\",[\"unknown\",[\"item\",\"position\"]],false],[\"close-element\"],[\"text\",\"\\n      \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-2\"],[\"flush-element\"],[\"text\",\"Rated \"],[\"append\",[\"unknown\",[\"item\",\"evaluation\",\"rating\"]],false],[\"close-element\"],[\"text\",\"\\n    \"],[\"close-element\"],[\"text\",\"\\n  \"],[\"close-element\"],[\"text\",\"\\n\"],[\"block\",[\"p\",\"body\"],null,null,1]],\"locals\":[\"p\"]}],\"hasPartials\":false}", "meta": { "moduleName": "ews/templates/components/notification-hierarchy-item.hbs" } });
});
define("ews/templates/components/notification-hierarchy", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "EwlOSAIs", "block": "{\"statements\":[[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"panel panel-default panel-ews panel-hierarchy\"],[\"flush-element\"],[\"text\",\"\\n  \"],[\"comment\",\" Default panel contents \"],[\"text\",\"\\n  \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"panel-heading\"],[\"flush-element\"],[\"text\",\"\\n    Your Direct Report\\n    \"],[\"open-element\",\"span\",[]],[\"static-attr\",\"class\",\"hidden-xs subtitle\"],[\"flush-element\"],[\"text\",\"\\n      \"],[\"append\",[\"helper\",[\"if\"],[[\"get\",[\"displaySubtitle\"]],\"Click the staff name or status to update attrition evaluation\"],null],false],[\"text\",\"\\n    \"],[\"close-element\"],[\"text\",\"\\n  \"],[\"close-element\"],[\"text\",\"\\n\\n  \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"row section-heading\"],[\"flush-element\"],[\"text\",\"\\n    \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-1\"],[\"flush-element\"],[\"text\",\"Pic\"],[\"close-element\"],[\"text\",\"\\n    \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-3\"],[\"flush-element\"],[\"text\",\"Name\"],[\"close-element\"],[\"text\",\"\\n    \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-3\"],[\"flush-element\"],[\"text\",\"Employee Id\"],[\"close-element\"],[\"text\",\"\\n    \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-3\"],[\"flush-element\"],[\"text\",\"Position\"],[\"close-element\"],[\"text\",\"\\n    \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-2\"],[\"flush-element\"],[\"text\",\"Status\"],[\"close-element\"],[\"text\",\"\\n  \"],[\"close-element\"],[\"text\",\"\\n\"],[\"block\",[\"each\"],[[\"get\",[\"reports\"]]],null,0],[\"close-element\"],[\"text\",\"\\n\"],[\"yield\",\"default\"],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[\"default\"],\"blocks\":[{\"statements\":[[\"text\",\"    \"],[\"append\",[\"helper\",[\"notification-hierarchy-item\"],null,[[\"item\"],[[\"get\",[\"report\"]]]]],false],[\"text\",\"\\n\"]],\"locals\":[\"report\"]}],\"hasPartials\":false}", "meta": { "moduleName": "ews/templates/components/notification-hierarchy.hbs" } });
});
...
define("ews/templates/notifications", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "+gQb0qU1", "block": "{\"statements\":[[\"append\",[\"unknown\",[\"navbar-ews\"]],false],[\"text\",\"\\n\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"container\"],[\"flush-element\"],[\"text\",\"\\n  \"],[\"append\",[\"helper\",[\"notification-hierarchy\"],null,[[\"reports\"],[[\"get\",[\"model\",\"subordinates\"]]]]],false],[\"text\",\"\\n\"],[\"close-element\"],[\"text\",\"\\n\"],[\"append\",[\"unknown\",[\"outlet\"]],false],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[],\"hasPartials\":false}", "meta": { "moduleName": "ews/templates/notifications.hbs" } });
});
...
define('ews/tests/mirage/mirage/fixtures/notifications.lint-test', ['exports'], function (exports) {
  QUnit.module('ESLint - mirage/fixtures/notifications.js');
  QUnit.test('should pass ESLint', function (assert) {
    assert.expect(1);
    assert.ok(true, 'mirage/fixtures/notifications.js should pass ESLint.\n');
  });
});
...
define('ews/tests/mirage/mirage/models/notification.lint-test', ['exports'], function (exports) {
  QUnit.module('ESLint - mirage/models/notification.js');
  QUnit.test('should pass ESLint', function (assert) {
    assert.expect(1);
...
if (!runningTests) {
  require("ews/app")["default"].create({"name":"ews","version":"0.0.0+b1b98a4b"});
}
